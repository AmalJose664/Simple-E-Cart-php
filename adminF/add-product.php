	...
	<div class="container">
		...
		<form id=<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> method="post" class="" enctype="multipart/form-data">
			...
			<div class="top shadow-hover">
				<h2>Add new Items to Shop</h2>
				<input type="submit" name="submit" required value="Add Product">
			</div>
				...
				<div class="box1 shadow-hover">
					<div class="inside-box">
						...
						<div class="file-box ">
							...
							<img id="file-image" src="" alt="" height="100px">
							<input type="file" name="file" id="file" accept="image/*" required>
						</div>
						<h6 style="margin: 10px 0; color:#3f4040">Pay Attention to the image quality while uploading*</h6>
					</div>
					...
					<div class="inside-box">
						...
						<div class="l-details details">
							<div class="price">
								Price
								<input type="number" value="" name="price" min="10" required placeholder="Price of Product" id="original-price" onkeyup="discountCalc()">
							</div>
						</div>
						<div class="l-details details">
							<div class="price">
								Discount in % (if Available)
								<input type="number" value="0" min="0" max="92" required placeholder="Discount in %" id="discount-value" onkeyup="discountCalc()" onchange="discountCalc()">
						...
						<div class="l-details details">
							<div class="price">
								Final Price
								<input type="number" value="900" name="discount-price" id="discount-price" required placeholder="Discount Price" readonly>
				...
				<div class="box2 shadow-hover">
					<div class="inside-box">
						...
						<label class="radio-box">
							<input required type="radio" class="radios" name="pro-Type" value="mobile" onclick="inputChange(1)">
							<span class="radio-span">
								<svg class="svg1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 120 120">
						...
						<label class="radio-box">
							<input required type="radio" class="radios" name="pro-Type" value="laptop" onclick="inputChange(2)">
							<span class="radio-span">
								<svg class="svg2" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 122.88 70.51" style="enable-background:new 0 0 122.88 70.51" xml:space="preserve">
									<style type="text/css">
										.st0 {
											fill-rule: evenodd;
											clip-rule: evenodd;
									...
									<g>
										<path class="st0" d="M2.54,65.44h12.59c-0.93-0.24-1.63-1.1-1.63-2.1V2.17C13.5,0.98,14.48,0,15.67,0h90.97 c1.19,0,2.17,0.98,2.17,2.17v61.16c0,1.01-0.69,1.86-1.63,2.1h13.16c1.4,0,2.54,1.14,2.54,2.54v0c0,1.4-1.14,2.54-2.54,2.54H2.54 c-1.4,0-2.54-1.14-2.54-2.54v0C0,66.58,1.14,65.44,2.54,65.44L2.54,65.44z M17.21,3.4h88.19v59.32H17.21V3.4L17.21,3.4z M57.87,66.39h7.14c0.67,0,1.22,0.55,1.22,1.22l0,0c0,0.67-0.55,1.22-1.22,1.22h-7.14c-0.67,0-1.22-0.55-1.22-1.22l0,0 C56.65,66.93,57.2,66.39,57.87,66.39L57.87,66.39z" />
									</g>
								</svg> Laptop an PC
							</span>
						</label>
						<label class="radio-box">
							<input required type="radio" class="radios" name="pro-Type" value="smartwatch" onclick="inputChange(3)">
							<span class="radio-span">
								<svg class="svg3" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
									<path d="M296.28 182.69h1.643l-6.486-81.131h-72.874l-6.477 81.132h1.634a27.521 27.521 0 0 0-27.533 27.538v95.066a27.509 27.509 0 0 0 25.899 27.45l6.477 77.696h72.874l6.476-77.696a27.51 27.51 0 0 0 25.9-27.45v-95.07a27.527 27.527 0 0 0-27.534-27.534zm-1.27 121.493h-80.03V211.33h80.03z" data-name="Smart Watch" />
								</svg>Smartwatches and Fitness
							</span>
						</label>
						<label class="radio-box">
							<input required type="radio" class="radios" name="pro-Type" value="headphones" onclick="inputChange(4)">
							<span class="radio-span">
								<svg xmlns="http://www.w3.org/2000/svg" width="29" height="29" fill="currentColor" class="bi bi-headphones" viewBox="0 0 16 16">
									<path d="M8 3a5 5 0 0 0-5 5v1h1a1 1 0 0 1 1 1v3a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V8a6 6 0 1 1 12 0v5a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1v-3a1 1 0 0 1 1-1h1V8a5 5 0 0 0-5-5" />
								</svg>Earphone and Headphones
							</span>
						</label>
						<label class="radio-box">
							<input required type="radio" class="radios" name="pro-Type" value="television" onclick="inputChange(5)">
							<span class="radio-span">
					...
					<div class="inside-box">
						...
						<div class="details">
							<div class="label1 input">
								<label for="pro-name">
									Product name
									<input required type="text" name="pro-name" value="" placeholder="Enter the displaying name">
								</label>
							</div>
						...
						<div class="details">
							<div class="label1 input">
								<label for="pro-name">
									Stocks Adding
									<input required type="number" min="3" name="pro-stocks" value="" placeholder="Enter the number of stocks">
								</label>
						...
						<div class="description">
							...
							<div class="textarea">
								<textarea name="description" id="" placeholder="Copy and Paste Expected"></textarea>
							</div>
						</div>
					</div>
				</div>
...
<script>
	...
	const brandOptions = {
		...
		tv: ['Sony', 'Samsung', 'acer', 'LG', 'Panasonic', 'TCL', 'Hisense', 'Vizio', 'Philips', 'Sharp', 'Toshiba', 'OnePlus', 'Mi (Xiaomi)', 'Realme', 'Vu', 'Sanyo', 'Haier', 'Onida', 'Thomson', 'iFFALCON', 'Kodak', 'Blaupunkt', 'Skyworth', 'Insignia', 'Hitachi', 'LeEco', 'Westinghouse', 'Nokia', 'Motorola', 'JVC', 'Akai'],
	};
...
if (!empty($_POST['submit'])) {
	...
	if ($_FILES["file"]["size"] > $maxSize) {
        ...
        (`pid`, `pro_name`, `pro_price`,`pro_simple_name`, `pro_discount_price`, `pro_type`, `pro_brand`, `pro_stocks`, `pro_description`, `pro_src`, `added_date`) 
        VALUES 
        (NULL, '$p_name', '$price', '$pro_simple_name' , '$discount_price', '$type', '$brand', '$stocks', '$description', '$file_name', NOW())";
