...
?>
<header>
	<a href="" class="logo"><img src="images/E-cart-logo.jpg" alt="Image or logo here"></a>
	<ul class="navbar">
		<li><a href="/projects/home.php#feature" class="active">Home</a></li>
		<li><a href="./my-orders.php">MyOrders</a></li>
		...
		<div class="account ">
			...
			if (array_key_exists('user_name', $_SESSION) && !empty($_SESSION['user_name'])) {
				if ($_SESSION['user_role'] == "admin") {
					echo "<a href='adminF/'>", "visit admin page", "</a>";
				}
				echo "<a href='user.php'>", $_SESSION['user_name'], "</a>";
				echo "<a style='color:red' href='account/logout.php'>Log Out</a>";
				echo "<a class='color-change' href='./change-theme.html'>Edit Site's color</a>";
				echo "<style>.dropdown i {
	                background-color: var(--theme-color);
	            }</style>";
			} else {
				echo "<a href='account/login.html'>Login</a>
...
<script>
	...
	function search() {
		document.forms[0].classList.toggle('search')
